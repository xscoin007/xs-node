...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The XSC-FINAL Today. game KAVINCREW@OUTLOOK.COM THE CODER";
        CTransaction txNew;
        txNew.nTime = 1583747915;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1583747915;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ?  1584973757  : 56438;
       // old block.ntime = 1582654891
...
//         assert(block.hashMerkleRoot == uint256("0x5c062f21472322a5ca5fd4df1f3b2832dc034f92dc113d4a9170dbb60713508a"));
           assert(block.hashMerkleRoot == uint256("0x138cee2bdd201b99d3b724db7e801e142ef31479cc8bf88917e750705ee9a279"));
